<template>
  ...
  <div class="container privacy">
    <h1>Privacy Policy for WitVet</h1>

    <p>
      At WitVet, accessible from https://witvet.pet, one of our main priorities
      is the privacy of our visitors. This Privacy Policy document contains
      types of information that is collected and recorded by WitVet and how we
      use it.
    </p>
    ...
    <p>
      ...
      and/or collect in WitVet. This policy is not applicable to any information
    ...
    <p>
      WitVet follows a standard procedure of using log files. These files log
    ...
    <p>
      Like any other website, WitVet uses 'cookies'. These cookies are used to
    ...
    <P
      ...
      advertising partners of WitVet.</P
    >

    <p>
      Third-party ad servers or ad networks uses technologies like cookies,
      JavaScript, or Web Beacons that are used in their respective
      advertisements and links that appear on WitVet, which are sent directly to
    ...
    <p>
      Note that WitVet has no access to or control over these cookies that are
    ...
    <p>
      WitVet's Privacy Policy does not apply to other advertisers or websites.
    ...
    <p>
      WitVet does not knowingly collect any Personal Identifiable Information
